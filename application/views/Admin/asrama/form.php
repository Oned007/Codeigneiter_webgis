...
}elseif($parameter=='review' && $id!=''){
    $this->db->where('id_input',$id);
    $row=$this->UserInputModel->get()->row_array();
    if ($row) {
        extract($row);
    }
}
			...
			<div class="card">
				...
				<div class="card-content">
	    			...
	    			?>
								...
								<!-- {{-- End Image --}} -->
								<?php if($parameter=='review' && $id!='') { ?>
								<div class="form-group row ">
									<div class="col-sm-10">
									<a href="<?=site_url($url.'/approve/'.$id_input)?>" class="btn btn-success" >Terima Data</a>
